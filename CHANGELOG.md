...
## [4.2.1](https://github.com/kustomhippie/cockroach/compare/v4.2.0...v4.2.1) (2025-08-04)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v25.2.3 ([#87](https://github.com/kustomhippie/cockroach/issues/87)) ([6099f6c](https://github.com/kustomhippie/cockroach/commit/6099f6c630154bea8cfaa981237927fd79c5475a))
* **deps:** update cockroachdb/cockroach docker tag to v25.2.4 ([#88](https://github.com/kustomhippie/cockroach/issues/88)) ([e68b03b](https://github.com/kustomhippie/cockroach/commit/e68b03b7fd90d31db1fa3c019b88adfffd2a9895))
...
* **deps:** update cockroachdb/cockroach docker tag to v25.2.1 ([#84](https://github.com/kustomhippie/cockroach/issues/84)) ([977a17d](https://github.com/kustomhippie/cockroach/commit/977a17d19d197af19ab2b01b978dde8717da6719))

## [4.1.0](https://github.com/kustomhippie/cockroach/compare/v4.0.5...v4.1.0) (2025-06-02)


### Features

* **deps:** update cockroachdb/cockroach docker tag to v25.2.0 ([#83](https://github.com/kustomhippie/cockroach/issues/83)) ([05c3be7](https://github.com/kustomhippie/cockroach/commit/05c3be77a5fcfa76b74de5c416a31530ad2931af))

## [4.0.5](https://github.com/kustomhippie/cockroach/compare/v4.0.4...v4.0.5) (2025-05-19)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v25.1.6 ([#82](https://github.com/kustomhippie/cockroach/issues/82)) ([dc26325](https://github.com/kustomhippie/cockroach/commit/dc26325dfcce144bdbbb88bd34dbecb34b05209f))
...
* **deps:** update cockroachdb/cockroach docker tag to v25.1.3 ([#79](https://github.com/kustomhippie/cockroach/issues/79)) ([9e138c5](https://github.com/kustomhippie/cockroach/commit/9e138c5d2454e13438774350cc9c4cf31ed37e32))
* **deps:** update cockroachdb/cockroach docker tag to v25.1.4 ([#80](https://github.com/kustomhippie/cockroach/issues/80)) ([6c5f366](https://github.com/kustomhippie/cockroach/commit/6c5f3663739716d396dbd6dc30aec58f92eeb383))

## [4.0.2](https://github.com/kustomhippie/cockroach/compare/v4.0.1...v4.0.2) (2025-03-24)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v25.1.2 ([#78](https://github.com/kustomhippie/cockroach/issues/78)) ([8bd021e](https://github.com/kustomhippie/cockroach/commit/8bd021e49b45a1b03b21a3a1c629e0f6d6851cf9))

## [4.0.1](https://github.com/kustomhippie/cockroach/compare/v4.0.0...v4.0.1) (2025-03-17)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v25.1.1 ([#77](https://github.com/kustomhippie/cockroach/issues/77)) ([2742efb](https://github.com/kustomhippie/cockroach/commit/2742efbfbd2db51517bac5f9302d9aea1be31a0e))

## [4.0.0](https://github.com/kustomhippie/cockroach/compare/v3.3.1...v4.0.0) (2025-03-10)


### Features

* **deps:** update cockroachdb/cockroach docker tag to v25 ([#76](https://github.com/kustomhippie/cockroach/issues/76)) ([27166ca](https://github.com/kustomhippie/cockroach/commit/27166ca292bc7c4f5b05f10c15dacf123e1ef1a1))

## [3.3.1](https://github.com/kustomhippie/cockroach/compare/v3.3.0...v3.3.1) (2025-02-24)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.3.6 ([#75](https://github.com/kustomhippie/cockroach/issues/75)) ([dbdeae0](https://github.com/kustomhippie/cockroach/commit/dbdeae09dcff06391836b2e1c73f8464621c73eb))

## [3.3.0](https://github.com/kustomhippie/cockroach/compare/v3.2.4...v3.3.0) (2025-02-17)


### Features

* **deps:** update quay.io/webhippie/alpine docker tag to v3.21 ([#74](https://github.com/kustomhippie/cockroach/issues/74)) ([bc0079b](https://github.com/kustomhippie/cockroach/commit/bc0079bdccc075404a41c146f96fd6224c24e73a))


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.3.5 ([#73](https://github.com/kustomhippie/cockroach/issues/73)) ([f546b15](https://github.com/kustomhippie/cockroach/commit/f546b15c7a5e4e6a298890cc54ae518185dfa9b2))

## [3.2.4](https://github.com/kustomhippie/cockroach/compare/v3.2.3...v3.2.4) (2025-02-03)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.3.4 ([#72](https://github.com/kustomhippie/cockroach/issues/72)) ([1e51036](https://github.com/kustomhippie/cockroach/commit/1e51036f001222263c285eb55d9b09fbd24ea79b))

## [3.2.3](https://github.com/kustomhippie/cockroach/compare/v3.2.2...v3.2.3) (2025-01-20)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.3.3 ([#71](https://github.com/kustomhippie/cockroach/issues/71)) ([be82cbb](https://github.com/kustomhippie/cockroach/commit/be82cbba6f1a29eed7eaa6a37b9c467512ba1737))
...
* **deps:** update cockroachdb/cockroach docker tag to v24.3.1 ([#69](https://github.com/kustomhippie/cockroach/issues/69)) ([3b0dce0](https://github.com/kustomhippie/cockroach/commit/3b0dce077fe7b0426dc4c649282b526dee4384d8))

## [3.2.0](https://github.com/kustomhippie/cockroach/compare/v3.1.5...v3.2.0) (2024-12-09)


### Features

* **deps:** update cockroachdb/cockroach docker tag to v24.3.0 ([#68](https://github.com/kustomhippie/cockroach/issues/68)) ([a56613d](https://github.com/kustomhippie/cockroach/commit/a56613d533be96dafc3b0644312c83ec51f15faf))

## [3.1.5](https://github.com/kustomhippie/cockroach/compare/v3.1.4...v3.1.5) (2024-11-25)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.2.5 ([#67](https://github.com/kustomhippie/cockroach/issues/67)) ([b44adb3](https://github.com/kustomhippie/cockroach/commit/b44adb3d6cb5a5e4c44c9083713e79e6f9882997))

## [3.1.4](https://github.com/kustomhippie/cockroach/compare/v3.1.3...v3.1.4) (2024-10-28)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.2.4 ([bdde2c1](https://github.com/kustomhippie/cockroach/commit/bdde2c15959196dad1629708d57ada96c356e25d))

## [3.1.3](https://github.com/kustomhippie/cockroach/compare/v3.1.2...v3.1.3) (2024-10-07)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.2.3 ([6235287](https://github.com/kustomhippie/cockroach/commit/6235287243385defb8bb25002e692494eb985ce7))

## [3.1.2](https://github.com/kustomhippie/cockroach/compare/v3.1.1...v3.1.2) (2024-09-30)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.2.2 ([7672a19](https://github.com/kustomhippie/cockroach/commit/7672a19c4f34226057970db13b7875f08666b915))

## [3.1.1](https://github.com/kustomhippie/cockroach/compare/v3.1.0...v3.1.1) (2024-09-16)


### Bugfixes

* **deps:** update cockroachdb/cockroach docker tag to v24.2.1 ([956197d](https://github.com/kustomhippie/cockroach/commit/956197de5af6f177f9d9c4d70a9a8fd9e2f977da))
